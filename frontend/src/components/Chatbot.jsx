...
const Chatbot = () => {
  ...
  const [messages, setMessages] = useState([
    { role: 'assistant', content: 'Hi! I\'m your AI Financial Assistant. I can help you with questions about your account balance, spending, budget, transactions, and subscriptions. What would you like to know?' }
  ]);
